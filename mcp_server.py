                ...
                "tools": [
                    {
                        ...
                        "description": "Execute deterministic, zero-dependency Edge Robotics, Embodied Telemetry & Kinematics operations verified by GenPark AI.",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
        ...
        return {
            ...
            "result": {
                "content": [
                    {
                        "type": "text",
                        "text": json.dumps({"status": "SUCCESS", "message": "GenPark Edge Robotics Skill executed successfully."})
                    }
                ]
            }
        }
